	...
	wc.service.declare({
	  ...
	  */
		,successHandler: function(serviceResponse) {
			...
			setDeleteCartCookie();
			document.location.href=getAbsoluteURL()+appendWcCommonRequestParameters("RESTOrderPrepare?langId="+WCParamJS.langId+"&storeId="+WCParamJS.storeId+"&catalogId="+WCParamJS.catalogId+"&orderId="+serviceResponse.orderId+"&URL="+getAbsoluteURL()+"AjaxCheckoutDisplayView?langId="+WCParamJS.langId+"&storeId="+WCParamJS.storeId+"&catalogId="+WCParamJS.catalogId);
		}
