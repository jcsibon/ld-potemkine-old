...
({
	...
	ERROR_CONTRACT_EXPIRED_GOTO_ORDER : "Nie można dodać wybranych pozycji do bieżącego zamówienia, ponieważ kontrakty dla niektórych pozycji zamówienia nie są już dostępne. Wybierz dostępne kontrakty, które mają być zastosowane do pozycji zamówienia.",
	...
	SHOPCART_ADDED : "Pozycja została pomyślnie dodana do bieżącego zamówienia.",
	PRICE : "Cena:",
	SKU : "Kod SKU:",
	PQ_PURCHASE : "Zakup:",
	PQ_PRICE_X : "${0} -",
	...
	ORDER_LINE_STATUS_G : "Przetwarzanie zamówienia",
	...
	ERROR_EmailTooLong : "Wartość wprowadzona w polu Adres e-mail jest zbyt długa.",
	ERROR_PhoneTooLong : "Wartość wprowadzona w polu Numer telefonu jest zbyt długa.",
	ERROR_FaxTooLong : "Wartość wprowadzona w polu Faks jest zbyt długa.",
	ERROR_RecipientEmpty : "Pole Odbiorca nie może być puste.",
	ERROR_LastNameEmpty : "Pole Nazwisko nie może być puste.",
	ERROR_MiddleNameEmpty : "Pole Drugie imię nie może być puste.",
	ERROR_AddressEmpty : "Pole Adres nie może być puste.",
	ERROR_CityEmpty : "Pole Miejscowość nie może być puste.",
	...
	ERROR_EmailEmpty : "Pole Adres e-mail nie może być puste.",
	ERROR_FirstNameEmpty : "Pole Imię nie może być puste.",
	ERROR_PhonenumberEmpty : "Pole Numer telefonu nie może być puste.",
	ERROR_PhoneEmpty : "Pole Numer telefonu nie może być puste.",
	ERROR_FaxEmpty : "Pole Faks nie może być puste.",
	ERROR_INVALIDEMAILFORMAT : "Wprowadzony adres e-mail ma niepoprawny format.",
	ERROR_INVALIDPHONE : "Wprowadzony numer telefonu ma niepoprawny format.",
	...
	AGE_WARNING_ALERT : "Jeśli nie masz ukończonych 13 lat, zanim przejdziesz dalej, przeczytaj nasze zasady ochrony prywatności dzieci.",
	...
	Logon_WaitingForApproval : "Otrzymano wniosek o rejestrację.  Twoje konto oczekuje na zatwierdzenie. Do czasu zatwierdzenia konta logowanie nie będzie możliwe.",
	...
	ERROR_ADD2CART_BROWSE_ONLY : "Nie można dodać produktu do bieżącego zamówienia w trybie tylko przeglądania.",
	
	// Add To Requisition List Messages	
	ERROR_SL_RESOLVED_SKU : "Wybór jest niekompletny. Wybierz wartość dla każdego atrybutu.",
