...
wc.service.declare({
	...
	,successHandler: function(serviceResponse) {
		...
		var url = 'RESTOrderShipInfoUpdate?URL=OrderShippingBillingView?&storeId='+storeId+'&catalogId='+catalogId+'&langId='+langId+'&orderId='+orderId+'&shipModeId='+shipModeId+'&allocate=***&backorder=***&remerge=***&check=*n';
		...
		url = appendWcCommonRequestParameters(url);
...
wc.service.declare({
	...
	,successHandler: function(serviceResponse) {
		...
		if(SBServicesDeclarationJS.isAjaxCheckOut()){
			...
			var url = "OrderShippingBillingView?storeId=" + SBServicesDeclarationJS.storeId + "&catalogId=" + SBServicesDeclarationJS.catalogId + "&langId=" + SBServicesDeclarationJS.langId + "&orderId=" + serviceResponse.orderId;
...
wc.service.declare({
	...
	,successHandler: function(serviceResponse) {
		...
		if(CheckoutHelperJS.isAjaxCheckOut()){
			...
			document.location.href=appendWcCommonRequestParameters(location.href);
		}	
