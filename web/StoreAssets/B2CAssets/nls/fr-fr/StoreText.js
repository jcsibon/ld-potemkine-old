...
({
	...
	WISHLIST_MISSINGEMAIL : "La zone Adresse électronique doit être renseignée. Indiquez l'adresse électronique de la personne à laquelle est destinée votre liste de présélection puis faites une nouvelle tentative.",
	...
	Logon_RegistrationRequired : "Les utilisateurs invités peuvent uniquement consulter le catalogue. Veuillez vous enregistrer ou vous connecter pour un accès complet au magasin.",
	...
	// CSR Widget
	CSR_NO_SEARCH_CRITERIA: "Aucun critère de recherche n'a été entré. Indiquez au moins un critère de recherche.",
	CSR_SUCCESS_CUSTOMER_ACCOUNT_ACCESS : "Accès réussi au compte client.",
	SUCCESS_ORDER_UNLOCK : "La commande a été déverrouillée.",
	SUCCESS_ORDER_LOCK : "La commande a été verrouillée.",
	SUCCESS_ORDER_TAKE_OVER : "Verrou adjugé.",
	CUSTOMER_ACCOUNT_ENABLE_SUCCESS: "Compte client activé.",
	CUSTOMER_ACCOUNT_DISABLE_SUCCESS: "Compte client désactivé.",
	DISABLE_CUSTOMER_ACCOUNT: "Désactiver le compte client",
	ENABLE_CUSTOMER_ACCOUNT: "Activer le compte client",
	RESET_PASSWORD_SUCCESS: "Mot de passe du client réinitialisé.",
	ORDER_CANCEL_SUCCESS: "Commande annulée.",
	CSR_SUCCESS_NEW_GUEST_USER_CREATION : "Client invité créé.",
	CSR_SUCCESS_NEW_REGISTERED_USER_CREATION : "Client enregistré créé.",
	CSR_PASSWORD_EMPTY: "La zone de mot de passe CSR est vide.",
	ERROR_RESET_PASSWORD_ACCESS_ACCOUNT_TO_RESET: "Echec de la réinitialisation du mot de passe pour le nouveau client enregistré. Veuillez accéder au compte du client pour réinitialiser le mot de passe.",
	PLEASE_SELECT:"Veuillez sélectionner",
	CSR_SESSION_TERMINATE_WARNING_MESSAGE : "La session en cours pour le client \"{0}\" va s'arrêter. Cliquez sur Oui pour terminer la session ou sur Non pour continuer la session en cours.",
	GUEST : "Invité",
	CSR_PASSWORD_EMPTY_MESSAGE: "Entrez votre mot de passe pour continuer.",
	_ERR_PASSWORD_FAILED:"Le mot de passe que vous avez entré n'est pas correct. Faites une nouvelle tentative.",
	ORDERS_SEARCH_BILLING_OPTION : "Informations concernant la facturation",
	ORDERS_SEARCH_SHIPPING_OPTION : "Informations sur la livraison",
	LOCK_CUSTOMER_ORDER_CSR : "Verrouiller la commande",
	UNLOCK_CUSTOMER_ORDER_CSR : "Déverrouiller la commande",
	ORDER_LOCKED_ERROR_MSG:"Le panier ou la commande \"{0}\" sont verrouillés. Pour plus d'informations, contactez un représentant du service clientèle",
	ADD_COMMENT_MESSAGE :"Cliquez ici pour ajouter un nouveau commentaire à la commande.",
	COMMENT_LENGTH_OUT_OF_RANGE : "Le commentaire ne peut pas dépasser 3000 caractères.",
	EMPTY_COMMENT : "Veuillez saisir un commentaire à ajouter à la commande."
})
